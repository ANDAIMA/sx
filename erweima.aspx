...
<html lang="en">
  ...
  <body class=""   > 
  <!--<![endif]-->
    <form name="aspnetForm" method="post" action="erweima.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJMjUzNTk5OTE4ZGSyR1Xksp0nmaurF5vjt+VHmwJS9A==" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="C6963172" />    
    <div class="content">
...
<div class="row-fluid">
    ...
    <div style="margin:10px;">请使用微信扫码下单</div>
    <div style="margin:10px;">

        <img src="/upload/12_agent.jpg" style="width:300px;" />
