...
<html lang="en">
  ...
  <body class="" > 
  <!--<![endif]-->
    <form name="aspnetForm" method="post" action="AddProduct_P.aspx" id="aspnetForm" enctype="multipart/form-data">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTE5MDA0NDA1NTMPZBYCZg9kFgICAw8WAh4HZW5jdHlwZQUTbXVsdGlwYXJ0L2Zvcm0tZGF0YRYCZg9kFgICFA8QZGQWAQIBZGSMYVIaRAsWnyXWUcri7az2eaOGQA==" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="44470D2C" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />    
    <div class="content">
...
<select name="ctl00$ContentPlaceHolder1$dropdownlist_PinLei" id="ctl00_ContentPlaceHolder1_dropdownlist_PinLei">
	<option value="速干型棒球帽">速干型棒球帽</option>
	<option value="棒球帽">棒球帽</option>
	<option value="速干型前进帽">速干型前进帽</option>
	<option value="冰袖">冰袖</option>
	<option value="平顶帽">平顶帽</option>
	<option value="手套">手套</option>
	<option value="针织帽">针织帽</option>
...
<td>
	...
	<option value="FZ/T73002-2006">FZ/T73002-2006</option>
	<option value="FZ/T82002-2016">FZ/T82002-2016</option>
	<option value="FZ/T73002-2016">FZ/T73002-2016</option>
	<option value="GB/T18830-2009">GB/T18830-2009</option>
